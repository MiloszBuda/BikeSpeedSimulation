...
export const translations: Record<Language, Translations> = {
  pl: {
    ...
    controls: {
      ...
      zeroWindTitle: 'Bezwietrznie (Zero Wind)',
      zeroWindDesc: 'Całkowite wyłączenie wiatru na całej trasie (v_wind = 0 m/s)',
  ...
  en: {
    ...
    controls: {
      ...
      zeroWindTitle: 'Calm / Zero Wind',
      zeroWindDesc: 'Completely disable wind along the entire route (v_wind = 0 m/s)',
